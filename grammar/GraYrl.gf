...
concrete GraYrl of Lex = open Oper, OperYrl in {
 flags coding=utf8 ;
  ...
  lin
    ...
    There = mkAdvLoc "ape" ;
    On = mkLocYrl "upé" ;
    In = mkLocYrl ("upé"|"pupé"|"kwara upé") ;
    With = mkLocYrl "irumu" ;
    Near = mkLocYrl "ruakí" NCS ;
...
Life = RelPrefNoun "sikwé";
Man = regNounYrl "apigawa";
Maria = properNameYrl "Maria";
Milk = regNounYrl ("kambí"|"kambí-yukisé");
Nest = RelPrefNoun "taití";
New = adjYrl "pisasú" C1;
Path = RelPrefNoun "pé";
Pedro = properNameYrl "Pedro";
Picture = RelPrefNoun "sangawa";
Pit = RelPrefNoun "taínha";
Pumpkin = regNounYrl "yurumú";
Red = adjYrl "piranga" C1;
River = regNounYrl ("paranã"|"paraná");
Round = adjYrl "apuã" C2;
Seed = RelPrefNoun "taínha";
Son_Of_Woman = regNounYrl ("mimbira"|"mbira" | "membira");
Son_Of_Man = RelPrefNoun "taíra" "taíra";
Daughter_Of_Woman = regNounYrl ("mimbira"|"mbira" | "membira");
Daughter_Of_Man = RelPrefNoun "tayera" "tayera";
Stone = regNounYrl "itá";
Street = RelPrefNoun "pé";
Strong = adjYrl "kirimbawa" C1;
Tapioca_Cake = regNounYrl "meyú";
Toucan = regNounYrl "tukana";
Tree = regNounYrl "mirá";
Water = regNounYrl "ií";
Wife = RelPrefNoun "simirikú" ("simirikú"|"ximirikú");
